...
public class DialogForm_setting extends javax.swing.JDialog {
     ...
     */
    public DialogForm_setting(java.awt.Frame parent, boolean modal, Customer p) {
        super(parent, modal);
        initComponents();
        ...
        jTextField2.setText(String.valueOf(p.getPassword()));
        jTextField3.setText(String.valueOf(p.getPhone()));
        jTextField4.setText(String.valueOf(p.getAddress()));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().equals("") || jTextField2.getText().equals("") || jTextField3.getText().equals("") || jTextField4.getText().equals("")) {
            ...
            try {
                ...
                int res = db.queryDML("UPDATE user SET name='" + jTextField1.getText() + "', password='" + jTextField2.getText() + "', address='" + jTextField4.getText() + "',"
                        + " phone='" + jTextField3.getText() + "' WHERE id = " + id);
